      ...
      <nav class="navbar navbar-default">
        ...
        <div class="jumbotron">
          <h4>Bienvenue  <?php echo $this->session->userdata('cpt_pseudo');?></h4>
                          ...
                          <form class="form-horizontal" action="<?php echo site_url("administrateurs/update_Auser");?>" target="_blank" method="post">
                          <fieldset>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input id="CPT_PSEUDO" name="<?php echo $user["CPT_PSEUDO"]; ?>" type="text" placeholder="pseudo" class="form-control input-md" required  value="<?php echo $user["CPT_PSEUDO"]; ?>" disabled="disabled">
